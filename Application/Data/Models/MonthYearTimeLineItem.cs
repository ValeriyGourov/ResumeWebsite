...
namespace Application.Data.Models
{
	...
	public sealed class MonthYearTimeLineItem : TimeLineItemBase
	{
		...
		{
			MonthYearTimeLineItem? typedOther = other as MonthYearTimeLineItem;
			if (typedOther == null)
			{
				return 1;
			}
		...
		private static DateTimeOffset MonthBeginning(DateTimeOffset dateTime) => new DateTimeOffset(dateTime.Year, dateTime.Month, dateTime.Day, 0, 0, 0, TimeSpan.Zero);
	}
}
