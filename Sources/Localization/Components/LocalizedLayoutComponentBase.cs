...
/// <summary>
/// Базовый компонент, который представляет макет, с поддержкой переключения культуры приложения
/// на лету. Все компоненты с макетом, требующие такой локализации, должны наследоваться от
/// данного класса.
/// </summary>
